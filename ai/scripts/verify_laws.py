...
CHECKS = [
    ...
    ("AMVV §6 — repealed (weggefallen)",
     ...
     "weggefallen"),
    ("BtMVV §4 — Verschreiben BtM (Tierarzt; human = §5/§12)",
     "https://www.gesetze-im-internet.de/btmvv_1998/__4.html",
     "Verschreiben"),
    ("BtMVV §12 — 7-Tage-Frist (Vorlage vor mehr als 7 Tagen ausgefertigt)",
     "https://www.gesetze-im-internet.de/btmvv_1998/__12.html",
     "vor mehr als sieben Tagen ausgefertigt"),
    ("SGB V §31 Abs.6 — GKV-Beitragssatzstabilisierungsgesetz (Cannabis/Homöopathie cut)",
     ...
     "Absatz 6"),
    ("SGB V §129 — Aut-idem/Rahmenvertrag (law says Rahmenvertrag, not Rabattvertrag)",
     "https://www.gesetze-im-internet.de/sgb_5/__129.html",
     "Rahmenvertrag"),
    ("AMG §73 Abs.3 — Bezug aus dem Ausland (Einzelimport = colloquial; law text differs)",
    ...
    ("ApBetrO §1 — Anwendungsbereich",
     ...
     "Apothekenbetrieb"),
    ("ApoG §16 — Zweigapotheke (definition; §7 ApoG = Leitung)",
     "https://www.gesetze-im-internet.de/apog/__16.html",
     "Zweigapotheke"),
